    ...
    if options.drawShowerDir:
       ...
       # try finding the shower origin
          ...
          if shower_start<0:
             ...
             for k in proj:
                 if k==1:
                    drawShowerAxis(h['simpleDisplay'], k, shower_start, ref_point.X(), shower_direction.X())
                 else:
                    drawShowerAxis(h['simpleDisplay'], k, shower_start, ref_point.Y(), shower_direction.Y())
    h['simpleDisplay'].Update()
