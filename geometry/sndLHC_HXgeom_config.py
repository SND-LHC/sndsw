...
#US and DS saturation values
             # Only a few central bars per plane see the shower and may saturate. These are bars 4 and 5 in US.
             # All other bars don't record any showers and don't saturate.
             ...
             system = ['US', 'DS']
             for sys in system:
               file_sat = open('/eos/experiment/sndlhc/calibration/MuFilter/'+sys+'/tb2023_'+sys+'_satur.json')
